...
Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230401.INginxCertificate
.Link
https://learn.microsoft.com/powershell/module/az.nginx/set-aznginxcertificate
#>
function Set-AzNginxCertificate {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230401.INginxCertificate])]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Nginx.private\Set-AzNginxCertificate_UpdateExpanded';
        }
...
NETWORKPROFILE <INginxNetworkProfile>: .
  ...
  [NetworkInterfaceConfiguration <INginxNetworkInterfaceConfiguration>]: 
    [SubnetId <String>]: 
.Link
https://learn.microsoft.com/powershell/module/az.nginx/set-aznginxdeployment
#>
function Set-AzNginxDeployment {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Nginx.Models.Api20230401.INginxDeployment])]
[CmdletBinding(DefaultParameterSetName='UpdateExpanded', PositionalBinding=$false, SupportsShouldProcess, ConfirmImpact='Medium')]
param(
    [Parameter(Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            UpdateExpanded = 'Az.Nginx.private\Set-AzNginxDeployment_UpdateExpanded';
        }
        if (('UpdateExpanded') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
