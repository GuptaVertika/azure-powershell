...
using static Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.PowerShell.PsHelpers;

namespace Microsoft.Azure.PowerShell.Cmdlets.Nginx.Runtime.PowerShell
{
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"./Az.Nginx.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: Nginx cmdlets"}'");
                ...
                {
                    sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Az.Nginx.private.dll"}'");
                }
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Az.Nginx.format.ps1xml").ToPsList();
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule Nginx".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
